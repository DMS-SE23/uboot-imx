...
{
	printf("Wendy_0914: set_display_en\n");
...
iomux_v3_cfg_t const display_pads[] = {
	MX6_PAD_EIM_D31__GPIO3_IO31 | MUX_PAD_CTRL(NO_PAD_CTRL),  /* LCD_PWR_EN */
	MX6_PAD_GPIO_1__GPIO1_IO01 | MUX_PAD_CTRL(NO_PAD_CTRL),  /* BLK_12V_EN */
	MX6_PAD_GPIO_0__GPIO1_IO00 | MUX_PAD_CTRL(NO_PAD_CTRL),  /* BLK_EN */
	MX6_PAD_SD1_DAT3__GPIO1_IO21 | MUX_PAD_CTRL(NO_PAD_CTRL),  /* BLK_PWM */
};
...
void set_lcd_pwm_en(void)
{
	printf("set_lcd_pwm_en\n");
	imx_iomux_v3_setup_multiple_pads(display_pads, ARRAY_SIZE(display_pads));
	gpio_direction_output(IMX_GPIO_NR(3, 31), 1);
}
EXPORT_SYMBOL_GPL(set_lcd_pwm_en);

void set_blk_12v_en(void)
{
	printf("set_blk_12v_en()\n");
	imx_iomux_v3_setup_multiple_pads(display_pads, ARRAY_SIZE(display_pads));
	gpio_direction_output(IMX_GPIO_NR(1, 1), 1);
}
EXPORT_SYMBOL_GPL(set_blk_12v_en);
...
void set_blk_pwm_disable(void)
{
	printf("set_blk_pwm_disable()\n");
	imx_iomux_v3_setup_multiple_pads(display_pads, ARRAY_SIZE(display_pads));
	gpio_direction_output(IMX_GPIO_NR(1, 21), 0);
}
EXPORT_SYMBOL_GPL(set_blk_pwm_disable);

void set_blk_pwm(void)
{
	printf("set_blk_pwm()\n");
	imx_iomux_v3_setup_multiple_pads(display_pads, ARRAY_SIZE(display_pads));
	gpio_direction_output(IMX_GPIO_NR(1, 21), 1);
}
EXPORT_SYMBOL_GPL(set_blk_pwm);
///////////////////////////////////////////////////////////
